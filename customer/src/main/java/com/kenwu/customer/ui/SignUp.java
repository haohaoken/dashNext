...
import static com.kenwu.mylibrary.SharedClass.*;
...
//    private String psw_confirm;
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.kenwu.customer.fileprovider",
                        photoFile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if((requestCode == 1 || requestCode == 2) && resultCode == RESULT_OK){
            Picasso.get().load(currentPhotoPath).into((ImageView)findViewById(R.id.img_profile));
        }
        ...
        if (requestCode == 3) {
            if (resultCode == RESULT_OK) {
                ...
                if(currentPhotoPath != null) {
                    ...
                    Picasso.get().load(R.drawable.ic_person_black_24dp).into((ImageView) findViewById(R.id.img_profile));
                }
